  ...
  return (
    <FestivalProvider>
      ...
      <div>
        ...
        <Route path="/recruit/company/:applicationId/result" element={<PrivateRoute allowedRoles={allRoles}><RecruitCompanyResult /></PrivateRoute>} />
        <Route path="/recruit/worker/:applicationId/result" element={<PrivateRoute allowedRoles={allRoles}><RecruitWorkerResult /></PrivateRoute>} />
